...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="/admin/categories/" class="active">Catégories</a>
    ...
    <div class="main-content">
        <div class="page-header">
            <h1>Catégories</h1>
            <a href="/admin/categories/new" class="btn">+ Créer</a>
        </div>
                ...
                <tbody>
                    <?php foreach ($categories as $cat): ?>
                        <tr>
                            ...
                            <td><small><?php echo escape($cat['slug']); ?></small></td>
                            <td><?php echo escape(substr($cat['description'] ?? '', 0, 50)); ?></td>
                            <td>
                                <a href="/admin/categories/edit/<?php echo $cat['id']; ?>" class="action-btn">Éditer</a>
